...
echo "==> Aplicando migrations — ambiente HOMOLOGAÇÃO"
...
sleep 3
docker compose logs --tail=30 api-hml

echo "==> Migrations homologação concluídas (verifique erros nos logs acima)."
