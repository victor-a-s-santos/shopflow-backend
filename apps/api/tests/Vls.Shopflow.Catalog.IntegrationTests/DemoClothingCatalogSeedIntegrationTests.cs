...
public sealed class DemoClothingCatalogSeedIntegrationTests
{
    ...
    private static IConfiguration CreateSeedConfiguration(bool enabled = true)
    {
        return new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Uploads:PublicBaseUrl"] = "http://localhost:5127"
            })
            .Build();
    }
    ...
    private static async Task RunDemoSeedAsync(CatalogDbContext catalogDb, InventoryDbContext inventoryDb)
    {
