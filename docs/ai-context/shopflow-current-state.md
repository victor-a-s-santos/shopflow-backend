...
| **PaymentsPix (backend)** | Fake + **Mercado Pago Orders API**; webhook via **mercadopago-sdk** + oráculo manual; logs app/secret/fingerprint; Paid só `processed`/`accredited` | Frontend QR, e-mail |
