...
| **IdentityAccess (backend)** | Admin + Customer auth, CSRF, policies `Backoffice`/`Customer`, **StoreAccess Open/Closed + CustomerAccessStatus (Fase 1)** | Frontend Fase 2 (guards, login unificado, tela de aprovações); e-mails Brevo Fase 3 |
